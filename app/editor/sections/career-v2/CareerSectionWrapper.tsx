...
import { Award, ChevronDown, ChevronUp, GripVertical } from 'lucide-react';
      ...
      >
        ...
        <div className="flex items-center gap-3 group-hover:pl-6 transition-all">
          ...
          <div className="text-left">
            <h3 className="text-sm font-bold text-gray-900">Career Highlights</h3>
            <p className="text-xs text-gray-600">Your work experience</p>
          </div>
        </div>
